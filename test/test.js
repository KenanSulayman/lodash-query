...
(function() {
    ...
    describe("lodash Query Tests", function() {
        ...
        it("has a score method", function() {
            ...
            results = _.query.score(collection, {
                price: {
                    $lt: 140
                },
                color: {
            ...
            assert.equal(_.find(results, item => item.name === 'dress')._score, 1);
            return assert.equal(_.find(results, item => item.name === 'shoes')._score, 0.5);
        });
        it("has a score method with a $boost operator", function() {
            var collection, results;
            collection = [{
                name: 'dress',
                color: 'red',
            ...
            assert.equal(_.find(results, item => item.name === 'dress')._score, 0.5);
            return assert.equal(_.find(results, item => item.name === 'shoes')._score, 1.5);
        });
        it("has a score method with a $boost operator - 2", function() {
            var collection, results;
            collection = [{
                name: 'dress',
                color: 'red',
            ...
            assert.equal(_.find(results, item => item.name === 'dress')._score, 2.5);
            return assert.equal(_.find(results, item => item.name === 'shoes')._score, 1);
        });
        it("score method throws if compound query", function() {
            var collection;
            collection = [{
                name: 'dress',
                color: 'red',
            ...
            return assert.throws(function() {
                return _.query.score(collection, {
                    $and: {
                        price: 100
                    },
                    $or: [{
        ...
        it("score method throws if non $and query", function() {
            var collection;
            collection = [{
                name: 'dress',
                color: 'red',
        ...
        return it("combination of $gt  and $not", function() {
            var a, result;
            a = create();
            result = _.query(a, {
                likes: {
